...
$busquedaelegida= "select * from productos where nombre='Accesorio' and genero='Niño'";
}
...
mysqli_free_result($consulta);
         ...
         <aside>
           ...
           <form id="formularioModificacion" method="POST" enctype="multipart/form-data" action="../procesar/busquedas.php">
                 ...
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Ninio/Ninios-accesorios.php">
