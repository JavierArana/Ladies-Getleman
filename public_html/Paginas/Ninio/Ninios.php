...
<input type="hidden" name="pagina" value="../Ninio/Ninios.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Ninio/Ninios.php">
<input type="hidden" name="cerrarsesion" value="../Ninio/Ninios.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
?>
            ...
            <section id="seccionArticulos">
               ...
               <section id="cen">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/pantalones/2.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
               ...
               <section id="der">
                  ...
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/pantalones/1.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
