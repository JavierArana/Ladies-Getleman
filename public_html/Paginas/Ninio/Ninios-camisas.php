...
<input type="hidden" name="pagina" value="../Ninio/Ninios-camisas.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Ninio/Ninios-camisas.php">
<input type="hidden" name="cerrarsesion" value="../Ninio/Ninios-camisas.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
$busquedaelegida= "select * from productos where nombre='Camisa' and genero='Niño'";
}
...
mysqli_free_result($consulta);
      ...
      <form id="formularioModificacion" method="POST" enctype="multipart/form-data" action="../procesar/busquedas.php">
                 ...
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Ninio/Ninios-camisas.php">
