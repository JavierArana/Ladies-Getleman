...
<input type="hidden" name="pagina" value="../Ninio/Ninios-jeans.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Ninio/Ninios-jeans.php">
<input type="hidden" name="cerrarsesion" value="../Ninio/Ninios-jeans.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
?>
            ...
            <section id="seccionArticulos">
               ...
               <section id="izq">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/1.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/2.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/3.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
               <section id="cen">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/4.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/5.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
               ...
               <section id="der">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/7.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/8.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninio/jeans/9.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
         ...
         <aside>
            ...
            <ul id="opcion">
               ...
               <li class="articulosCaballero"><a href="Ninios-jeans.php" style="color:red; font-size:1.5em;">Jeans</a></li>
