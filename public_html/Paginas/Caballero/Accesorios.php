...
<html>
    <head>
        ...
        <script type="text/javascript" src="../../JavaScript/OpenedCaballero/funcionesAc.js"></script>       
...
<input type="hidden" name="pagina" value="../Caballero/Accesorios.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Caballero/Accesorios.php">
<input type="hidden" name="cerrarsesion" value="../Caballero/Accesorios.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
