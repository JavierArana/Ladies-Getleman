...
<input type="hidden" name="pagina" value="../Caballero/Caballero.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Caballero/Caballero.php">
<input type="hidden" name="cerrarsesion" value="../Caballero/Caballero.php">
 <table  class="tabla">
             <tr>
             <td>Bienvenido:</td>
...
$busquedaelegida ="select * from productos where genero='Caballero' limit $a,$b";
}
...
<section class="contenedorbtn">
            ...
            <aside>
                ...
                <ul id="opcion">
                 ...
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Caballero/Caballero.php">
