...
<html>
   <head>
      ...
      <script type="text/javascript" src="../../JavaScript/OpenedCaballero/funcionesJe.js"></script>
...
<input type="hidden" name="pagina" value="../Caballero/Jeans.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Caballero/Jeans.php">
<input type="hidden" name="cerrarsesion" value="../Caballero/Jeans.php">
<table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
?>
            ...
            <section id="seccionArticulos">
               ...
               <section id="izq">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/1.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/2.jpg" onclick="abrirImagen2();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/3.jpg" onclick="abrirImagen3();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
               <section id="cen">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/4.jpg" onclick="abrirImagen4();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/5.jpg" onclick="abrirImagen5();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/6.jpg" onclick="abrirImagen6();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
               <section id="der">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/7.jpg" onclick="abrirImagen7();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/8.jpg" onclick="abrirImagen8();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Caballero/Jeans/9.jpg" onclick="abrirImagen9();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
         ...
         <aside>
            ...
            <ul id="opcion">
               ...
               <li class="articulosCaballero"><a href="Jeans.php" style="color:red; font-size:1.5em;">Jeans</a></li>
