...
$busquedaelegida=  "select * from productos where nombre='Pantalon' and genero='Caballero'";
}
...
mysqli_free_result($consulta);
         ...
         <aside>
           ...
           <form id="formularioModificacion" method="POST" enctype="multipart/form-data" action="../procesar/busquedas.php">
                 ...
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Caballero/Pantalon.php">
