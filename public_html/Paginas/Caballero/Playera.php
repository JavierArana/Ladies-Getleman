...
//$a=1;
//$b=9;
//$consulta = mysqli_query($conexion, "select * from productos where nombre='Playera' and genero='Caballero' limit $a,$b ");
 #-------------------------codigo--------------------------------------
...
$busquedaelegida=  "select * from productos where nombre='Playera' and genero='Caballero'";
}
...
mysqli_free_result($consulta);
         ...
         <aside>
            ...
            <form id="formularioModificacion" method="POST" enctype="multipart/form-data" action="../procesar/busquedas.php">
                 ...
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Caballero/Playera.php">

                 <input type="hidden" name="nombre" id="nombre" value="Playera">
