...
<html> 
    <head>
        ...
        <link rel="stylesheet" href="../Estilos/modestilo.css">
                    ...
                    <div>
                        <form id="formulario" method="post" enctype="multipart/form-data" action="procesar/insertar.php">
                         ...
                         <input type="hidden" name="pagina" value="../Registro.php">
                            <p id="Tituloreg">Modificar datos del usuario</p> 
                            ...
                            <fieldset class="grupo">
                                ...
                                <button class="small round button" value="Registrar" id="botonreg">Guardar cambios</button> 
