...
<input type="hidden" name="pagina" value="../Dama/Dama-Vestidos.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Dama/Dama-Vestidos.php">
<input type="hidden" name="cerrarsesion" value="../Dama/Dama-Vestidos.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
$busquedaelegida=  "select * from productos where nombre='Vestido' and genero='Dama'";
}
...
mysqli_free_result($consulta);
         ...
         <aside>
            ...
            <ul id="opcion">
               ...
               <li class="articulosCaballero"><a href="Dama-Vestidos.php" style="color:red; font-size:1.5em;">Vestidos</a></li>
            ...
            <form id="formularioModificacion" method="POST" enctype="multipart/form-data" action="../procesar/busquedas.php">
                 ...
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Dama/Dama-Vestidos.php">
