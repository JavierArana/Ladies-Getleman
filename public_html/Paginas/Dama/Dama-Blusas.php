...
<input type="hidden" name="pagina" value="../Dama/Dama-Blusas.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Dama/Dama-Blusas.php">
<input type="hidden" name="cerrarsesion" value="../Dama/Dama-Blusas.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
?>
            ...
            <section id="seccionArticulos">
               ...
               <section id="izq">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/12.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/11.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/3.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
               <section id="cen">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/4.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/5.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/6.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
               <section id="der">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/7.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/8.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/9.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
         ...
         <aside>
            ...
            <ul id="opcion">
               <li class="articulosCaballero"><a href="Dama-Blusas.php" style="color:red; font-size:1.5em;">Blusas</a></li>
