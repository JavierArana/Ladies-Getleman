...
<input type="hidden" name="pagina" value="../Dama/Dama.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Dama/Dama.php">
<input type="hidden" name="cerrarsesion" value="../Dama/Dama.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
?>
            ...
            <section id="seccionArticulos">
               ...
               <section id="izq">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Vestidos/1.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Blusas/1.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Jeans/5.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
               <section id="cen">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Pantalon/2.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
               ...
               <section id="der">
                  ...
                  <article>
                     <figure>
                        <img src="../../Imagenes/Dama/Accesorios/1.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
