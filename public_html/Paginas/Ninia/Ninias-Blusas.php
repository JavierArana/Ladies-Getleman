...
<input type="hidden" name="pagina" value="../Ninia/Ninias-Blusas.php">
               <table  class="tabla">
             <tr>
...
<form action="../procesar/login.php" method="post">
<input type="hidden" name="pagina" value="../Ninia/Ninias-Blusas.php">
<input type="hidden" name="cerrarsesion" value="../Ninia/Ninias-Blusas.php">
 <table  class="tabla">
             <tr>
               <td>Bienvenido:</td>
...
$busquedaelegida= "select * from productos where nombre='Blusa' and genero='Niña'";
}
...
mysqli_free_result($consulta);
         ...
         <aside>
            ...
            <ul id="opcion">
               <li class="articulosCaballero"><a href="Ninias-Blusas.php" style="color:red; font-size:1.5em;">Blusas</a></li>
           ...
           <form id="formularioModificacion" method="POST" enctype="multipart/form-data" action="../procesar/busquedas.php">
                 <input type="hidden" name="genero" id="genero" value="Niña">
                 <input type="hidden" name="ubicacion" id="ubicacion" value="../Ninia/Ninias-Blusas.php">

                <input type="hidden" name="nombre" id="nombre" value="Blusa">
