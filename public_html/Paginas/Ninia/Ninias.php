         ...
         <section id="contenido">
            ...
            <section id="seccionArticulos">
               ...
               <section id="izq">
                  ...
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninia/Blusas/1.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
               ...
               <section id="cen">
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninia/Faldas/2.jpg" onclick="abrirImagen();">
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninia/Jeans/1.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
                  <article>
                     <figure>
                        <img src="../../Imagenes/Ninia/Short/1.jpg" onclick="abrirImagen();"><br>
                        <figcaption>Marca:<br>Costo:$</figcaption>
                     </figure>
                  </article>
               </section>
